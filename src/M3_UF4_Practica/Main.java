		...
		while (!sortir) {
			...
			if (lector.hasNextInt()) {
				...
				switch (opcio) {
					...
					case 1:
						M3_UF4_Practica.MenusSecundaris.Dades.MenuDades(); //Primer menu per afegir, modificar i llisar clubs, esportistes i proves
						break;
						
					case 2:
						M3_UF4_Practica.MenusSecundaris.Inscripcio.MenuInscripcio(); //Segon menu per a inscriure, anular i llistar participants
						break;
						
					case 3:
						M3_UF4_Practica.MenusSecundaris.ProvesM.MenuProves(); //Tercer menu per a veure les classificacions de les proves i classificar participants i proves
						break;
