...
public class ProvesStringClasse {
	...
	public static void main(String[] args) {
		...
		lletresNumeros.equals("225 - objectes"); //Mirar si tot el contingut de la cadena coincideix
		lletresNumeros.equalsIgnoreCase("225 - OBJECTES"); //Mirar si tot el contingut de la cadena coincideix (ignorar majúscules)
		//EXEMPLES
		System.out.println(lletresNumeros.concat(" totals"));
		System.out.println("Paraula 'e' repetida: "+lletresNumeros.contains("e"));
		System.out.println("Acaba amb 'totals': "+lletresNumeros.endsWith("totals"));
		System.out.println("La cadena (225 - objectes) coincideix amb (225 - objectes totals) : "+lletresNumeros.equals("225 - objectes"));
		System.out.println("La cadena (225 - objectes totals) coincideix amb (225 - objectes totals) : "+lletresNumeros.equals("225 - objectes totals"));
		System.out.println("La cadena (225 - OBJECTES totals) coincideix (ignorar majúscules) amb (225 - objectes totals) : "+lletresNumeros.equalsIgnoreCase("225 - OBJECTES totals"));
		System.out.println("-------------------------------------");
		...
		System.out.println("Substituir totes les o per 0: "+lletresNumeros.replaceFirst("o", "0")); //Substuir el primer 
