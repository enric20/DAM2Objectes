...
public class Support {
	 ...
	 * @param dataNaixementEsportista Date
	 * @return String "Vetera" o "Absolut"
	 */
	public static String RetornarAbsolutVetera(java.util.Date dataNaixementEsportista) {
		//LocalDate.of(1969, 12, 31)
		Date dataCategoria = Date.valueOf(LocalDate.of(1969, 12, 31));
		
		
		if (dataNaixementEsportista.before(dataCategoria)) { //Si la data naixement es abans del 1969 12 31
			return "Absolut";
		}
		else {
			return "Vetera";
